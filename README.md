# Hi there, I'm Soraphu Thongjun! 👋

I am a passionate **Computer Engineering student** and **Full-Stack Developer** focused on building efficient, modern web applications.
---

### 🚀 About Me
- 🎓 **Education:** Pursuing a Bachelor of Engineering in Computer Engineering
- ⚡ **Focus:** Full-Stack Web Development, System Integration, & API Design
- 🤖 **Workflow:** Embracing modern workflows using AI tools (Gemini/Copilot) to scale up prototyping and focus on core logic implementation.

---

### 🛠️ Tech Stack & Tools

- **Languages & Frameworks:** JavaScript, TypeScript, PHP, React, Node.js, Express, Fastify
- **Databases & BaaS:** MySQL, MongoDB, Prisma, Supabase
- **DevOps & Utilities:** Docker, Nginx, Git, Socket.io

---

### 📂 Featured Projects

#### 🎟️ [Modern-Loyalty-Points-Management-System](https://github.com/soraphu/modern-loyalty-points-management-system)
...
### 📫 Connect with Me
- **LinkedIn:** [linkedin.com/in/soraphu-thongjiun](https://linkedin.com/in/soraphu-thongjiun)
- **Email:** [soraphu.th@gmail.com](mailto:soraphu.th@gmail.com)
